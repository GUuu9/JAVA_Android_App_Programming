...
public class Self0903 extends AppCompatActivity {
    ...
    private void clickIcons() {
        ...
        ibZoomin.setBackgroundColor(Color.WHITE);
        ...
        ibZoomout.setBackgroundColor(Color.WHITE);
        ...
        ibRotate.setBackgroundColor(Color.WHITE);
        ...
        ibBright.setBackgroundColor(Color.WHITE);
        ...
        ibDark.setBackgroundColor(Color.WHITE);
        ...
        ibBlur.setBackgroundColor(Color.WHITE);
        ibBlur.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (blur == true) {
                    ...
                    blur = true;
                    ibBlur.setBackgroundColor(Color.LTGRAY);
                }
                graphicView.invalidate();
            }
        });
        ...
        ibEmbos.setBackgroundColor(Color.WHITE);
        ibEmbos.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (embos == true) {
                    ...
                    embos = true;
                    ibEmbos.setBackgroundColor(Color.LTGRAY);
                }
                graphicView.invalidate();
            }
        });
