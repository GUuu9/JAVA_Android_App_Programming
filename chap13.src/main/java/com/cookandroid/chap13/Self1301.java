package com.cookandroid.chap13;
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    textex.setText(selectedMP3 + "play 중입니다");
        ...
        btnPause.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (PAUSED == false) {
                    ...
                    textex.setText(selectedMP3 + " 일시정지중입니다.");
                    PAUSED = true;
                    ...
                    textex.setText(selectedMP3 + " 이어듣기중입니다.");
                    pbMP3.setVisibility(View.VISIBLE);
                }
            }
        });
